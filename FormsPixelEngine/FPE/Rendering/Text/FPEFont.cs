    ...
    */
    public class FPEFont : IAsset
    {
        ...
        */
        ...
        public int GetTextWidth(string _str) {
            int _width = 0;
            foreach (char _c in _str) {
                _width += (int)GetChar(_c).width + (int)Kerning;
            }

            return _width;
        }

        public int GetTextHeight(string _str) {
            return _str.Trim().Split('\n').Length * VerticalSpacing;
        }
